...
def clone(path_source, path_destination):
    ...
    for x in range(len(folders_to_clone)):
        path_source_clone = os.path.join(path_source, folders_to_clone[x])
        path_destination_clone = os.path.join(path_destination, folders_to_clone[x])
        if os.path.isdir(path_source_clone):
            ...
            print("PiClone '" + folders_to_clone[x] + "' folder ")
            os.system(clone_command)
            print("('" + folders_to_clone[x] + "' cloned)\n")
        else:
            print("'" + folders_to_clone[x] + "' folder does not exist in Source Disk\n")        
